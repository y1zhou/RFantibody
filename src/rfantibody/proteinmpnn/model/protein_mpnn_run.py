...
def main(args):
    ...
    from rfantibody.proteinmpnn.model.protein_mpnn_utils import loss_nll, loss_smoothed, gather_edges, gather_nodes, gather_nodes_t, cat_neighbors_nodes, _scores, _S_to_seq, tied_featurize, parse_PDB, parse_fasta
    from rfantibody.proteinmpnn.model.protein_mpnn_utils import StructureDataset, StructureDatasetPDB, ProteinMPNN
